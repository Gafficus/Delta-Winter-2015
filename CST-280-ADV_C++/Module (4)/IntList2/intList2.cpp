...
/************************************************************/
/* Reset current position indicator to point before first   */
/* position                                                 */
/************************************************************/
void IntList::ResetList()
{
   currPos = -1;
}

/************************************************************/
/* Advance to next position and retreive integer item there */
/************************************************************/
int IntList::GetNextItem()
{
   currPos++;             // Advance to next position
   return list[currPos];  // Get data at current position
}

/************************************************************/
/* Determines if at end of list (currPos == size)           */
/************************************************************/
bool IntList::atEnd()
{
   if (currPos == (size - 1))
